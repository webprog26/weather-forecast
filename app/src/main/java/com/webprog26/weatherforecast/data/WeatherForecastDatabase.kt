...
@Database(entities = [UserLocationData::class, DailyForecastData::class, HourlyForecastData::class, FiveDaysDailyForecastData::class], version = 1, exportSchema = false)
